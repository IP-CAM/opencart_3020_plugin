			     ...
			     <div id="product">
			      ...
			      <div class="options">
			        ...
			        <div class="options2">
						...
						<script src="/tools/js/jquery-labelauty.js"></script>
						<link rel="stylesheet" href="/tools/css/jquery-labelauty.css">
						<style>
						...
						<script>
     			         ...
     			         <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
     			           ...
     			           <div id="input-option<?php echo $option['product_option_id']; ?>">
							   <ul class="dowebok">
     			             <?php foreach ($option['product_option_value'] as $option_value) { ?>
     			             <li style="padding-right: 10px" class="labelauty">
     			                 	<input type="radio" class="labelauty" name="option[<?php echo $option['product_option_id']; ?>]" data-labelauty="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" value="<?php echo $option_value['product_option_value_id']; ?>" />
     			             </li>
     			             <?php } ?>
							   </ul>
